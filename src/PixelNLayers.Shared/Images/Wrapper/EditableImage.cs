...
{
    private readonly Stack<IReadOnlyList<PixelData>> HistoryData = new Stack<IReadOnlyList<PixelData>>();
    private readonly Stack<IReadOnlyList<PixelData>> UndoHistoryData = new Stack<IReadOnlyList<PixelData>>();
    ...
    {
        foreach (var pixelData in data) this[pixelData.X, pixelData.Y] = pixelData.PreviousColor;
    }

    private void DoForward(IReadOnlyList<PixelData> data)
    {
        foreach (var pixelData in data) this[pixelData.X, pixelData.Y] = pixelData.Color;
    }
